...
class __TwigTemplate_861d3e2b71d9e55370dbb204354b3da1 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitor"]) || array_key_exists("visitor", $context) ? $context["visitor"] : (function () { throw new RuntimeError('Variable "visitor" does not exist.', 15, $this->source); })()), "getColumn", ["countryFlag"], "method", false, false, false, 15)) {
            ...
            yield "</li>
                ";
            // line 26
            if (((isset($context["isProfileEnabled"]) || array_key_exists("isProfileEnabled", $context) ? $context["isProfileEnabled"] : (function () { throw new RuntimeError('Variable "isProfileEnabled" does not exist.', 26, $this->source); })()) &&  !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitor"]) || array_key_exists("visitor", $context) ? $context["visitor"] : (function () { throw new RuntimeError('Variable "visitor" does not exist.', 26, $this->source); })()), "getColumn", ["visitorId"], "method", false, false, false, 26)))) {
                yield "<li>";
    ...
    ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitor"]) || array_key_exists("visitor", $context) ? $context["visitor"] : (function () { throw new RuntimeError('Variable "visitor" does not exist.', 31, $this->source); })()), "getColumn", ["browserIcon"], "method", false, false, false, 31)) {
            ...
            yield "</li>
                ";
            // line 37
            if ((Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitor"]) || array_key_exists("visitor", $context) ? $context["visitor"] : (function () { throw new RuntimeError('Variable "visitor" does not exist.', 37, $this->source); })()), "getColumn", ["pluginsIcons"], "method", false, false, false, 37)) > 0)) {
                // line 38
                yield "                    <li>
                        ";
                // line 39
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["pluginIcon"]) {
                    ...
                    yield "\" alt=\"";
                    yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::capitalize($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["pluginIcon"], "pluginName", [], "any", false, false, false, 41), true), "html", null, true);
                    yield "\"/>
                        ";
                }
...
", "@Live/_visitorLogIcons.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Live/templates/_visitorLogIcons.twig");
    }
}
