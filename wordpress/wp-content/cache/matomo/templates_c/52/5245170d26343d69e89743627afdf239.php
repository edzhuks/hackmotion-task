...
class __TwigTemplate_a4743b6668bcf5a17cf2705b9d9fa194 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 6
        yield "    ";
        if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty((isset($context["title"]) || array_key_exists("title", $context) ? $context["title"] : (function () { throw new RuntimeError('Variable "title" does not exist.', 6, $this->source); })()))) {
            yield "<h2 class=\"card-title\"
                                    ";
            // line 7
            if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty((isset($context["titleAttributes"]) || array_key_exists("titleAttributes", $context) ? $context["titleAttributes"] : (function () { throw new RuntimeError('Variable "titleAttributes" does not exist.', 7, $this->source); })()))) {
    ...
    ";
        ...
        // line 13
        yield "            ";
        if ((Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["sparklines"]) || array_key_exists("sparklines", $context) ? $context["sparklines"] : (function () { throw new RuntimeError('Variable "sparklines" does not exist.', 13, $this->source); })())) == 1)) {
            // line 14
            yield "            ";
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(Matomo\Dependencies\Twig\Extension\CoreExtension::first($this->env->getCharset(), (isset($context["sparklines"]) || array_key_exists("sparklines", $context) ? $context["sparklines"] : (function () { throw new RuntimeError('Variable "sparklines" does not exist.', 14, $this->source); })())));
            $context['loop'] = [
    ...
    ";
        ...
        yield "
            ";
        // line 37
        if ((Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["sparklines"]) || array_key_exists("sparklines", $context) ? $context["sparklines"] : (function () { throw new RuntimeError('Variable "sparklines" does not exist.', 37, $this->source); })())) == 1)) {
            // line 38
            yield "            ";
            $context['_parent'] = $context;
    ...
    ";
        // line 66
        if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty((isset($context["footerMessage"]) || array_key_exists("footerMessage", $context) ? $context["footerMessage"] : (function () { throw new RuntimeError('Variable "footerMessage" does not exist.', 66, $this->source); })()))) {
            // line 67
...
{% endif %}", "@CoreVisualizations/_dataTableViz_sparklines.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/CoreVisualizations/templates/_dataTableViz_sparklines.twig");
    }
}
