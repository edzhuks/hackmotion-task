...
class __TwigTemplate_4244152cc193d21cf2743e6ec3df8a65 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["action"] ?? null), "url", [], "any", true, true, false, 1) && Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), Matomo\Dependencies\Twig\Extension\CoreExtension::trim(CoreExtension::getAttribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 1, $this->source); })()), "url", [], "any", false, false, false, 1))))) {
            // line 2
            yield "
";
            // line 3
...
";
        ...
        // line 13
        if (((CoreExtension::getAttribute($this->env, $this->source, ($context["action"] ?? null), "siteSearchCategory", [], "any", true, true, false, 13)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["action"] ?? null), "siteSearchCategory", [], "any", false, false, false, 13), false)) : (false))) {
            // line 14
            yield "
";
            // line 15
        ...
        // line 16
        if (((CoreExtension::getAttribute($this->env, $this->source, ($context["action"] ?? null), "siteSearchCount", [], "any", true, true, false, 16)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["action"] ?? null), "siteSearchCount", [], "any", false, false, false, 16), false)) : (false))) {
            // line 17
            yield "
";
            // line 18
...
{{ 'Actions_ColumnSearchResultsCount'|translate }}: {{ action.siteSearchCount|rawSafeDecoded }}{% endif %}", "@Live/_actionTooltip.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Live/templates/_actionTooltip.twig");
    }
}
