...
class __TwigTemplate_de7252727a72b842a82b016e1ac20384 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
        ...
        <div class=\"visitor-profile-visit-details\">
            ...
            <a href=\"#\" class=\"visitor-profile-show-actions\">
                ";
            // line 17
            $context["actionCount"] = Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["actionDetails"], "method", false, false, false, 17));
            // line 18
            yield "                ";
...
{% endfor %}", "@Live/getVisitList.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Live/templates/getVisitList.twig");
    }
}
