...
class __TwigTemplate_b1dbdfc5db40a0804d038b7cf5e71f76 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["actionGroup"]) {
            // line 3
            yield "    ";
            if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["actionGroup"], "pageviewAction", [], "any", false, false, false, 3))) {
                // line 4
                yield "    ";
    ...
    ";
            // line 9
            if (( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["actionGroup"], "actionsOnPage", [], "any", false, false, false, 9)) ||  !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["actionGroup"], "refreshActions", [], "any", false, false, false, 9)))) {
                // line 10
                yield "    ";
                if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["actionGroup"], "pageviewAction", [], "any", false, false, false, 10))) {
                    // line 11
                    yield "    <li class=\"pageviewActions\" data-view-count=\"";
                    yield \Piwik\piwik_escape_filter($this->env, (Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["actionGroup"], "refreshActions", [], "any", false, false, false, 11)) + 1), "html", null, true);
                    yield "\" data-actions-on-page=\"";
                    yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["actionGroup"], "actionsOnPage", [], "any", false, false, false, 11)), "html", null, true);
                    yield "\">
        <ol class=\"actionList\">
    ";
                }
        ...
        ";
                ...
                // line 27
                yield "    ";
                if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["actionGroup"], "pageviewAction", [], "any", false, false, false, 27))) {
                    // line 28
...
{% endif %}", "@Live/_actionsList.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Live/templates/_actionsList.twig");
    }
}
