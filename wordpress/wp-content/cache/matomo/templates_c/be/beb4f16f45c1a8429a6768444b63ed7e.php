...
class __TwigTemplate_c96c4dcf6e0bddb344ee690f4ac21b35 extends Template
{
    private $source;
    private $macros = [];
    ...
    <p>";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entry"]) {
            // line 6
            $context["entryCity"] = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
                // line 7
                if (((CoreExtension::getAttribute($this->env, $this->source, $context["entry"], "cities", [], "any", true, true, false, 7) && (1 == Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["entry"], "cities", [], "any", false, false, false, 7)))) && Matomo\Dependencies\Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, $context["entry"], "cities", [], "any", false, false, false, 7)))) {
                    // line 8
                    yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, $context["entry"], "cities", [], "any", false, false, false, 8)), "html", null, true);
                } elseif ((CoreExtension::getAttribute($this->env, $this->source,                 // line 9
$context["entry"], "cities", [], "any", true, true, false, 9) && (1 < Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["entry"], "cities", [], "any", false, false, false, 9))))) {
                    // line 10
                    yield "<span title=\"";
                    yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, $context["entry"], "cities", [], "any", false, false, false, 10), ", "), "html", null, true);
                    yield "\">";
            ...
            ";
            // line 14
            $context["entryVisits"] = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
                // line 15
                yield "<strong>
                    ";
                // line 16
            ...
            ";
            // line 24
            $context["entryCountry"] = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
                // line 25
        ...
        if (Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(((array_key_exists("userCountryMapUrl", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["userCountryMapUrl"]) || array_key_exists("userCountryMapUrl", $context) ? $context["userCountryMapUrl"] : (function () { throw new RuntimeError('Variable "userCountryMapUrl" does not exist.', 36, $this->source); })()), "")) : ("")))) {
            yield "style=\"display:none\"";
        }
        yield ">(";
        yield Matomo\Dependencies\Twig\Extension\CoreExtension::replace($this->env->getFilter('translate')->getCallable()("Live_ShowMap"), [" " => "&nbsp;"]);
...
</div>", "@UserCountry/_profileSummary.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/UserCountry/templates/_profileSummary.twig");
    }
}
