...
class __TwigTemplate_fc6a0640730e64c2b751d4300a4770f4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div id=\"piwik-promo-share\">
        ...
        yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::urlencode((isset($context["promoVideoUrl"]) || array_key_exists("promoVideoUrl", $context) ? $context["promoVideoUrl"] : (function () { throw new RuntimeError('Variable "promoVideoUrl" does not exist.', 16, $this->source); })())), "html", null, true);
        yield "\" rel=\"noreferrer noopener\" target=\"_blank\">
        ...
        yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::urlencode((isset($context["shareText"]) || array_key_exists("shareText", $context) ? $context["shareText"] : (function () { throw new RuntimeError('Variable "shareText" does not exist.', 21, $this->source); })())), "html", null, true);
        yield "&url=";
        yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::urlencode((isset($context["promoVideoUrl"]) || array_key_exists("promoVideoUrl", $context) ? $context["promoVideoUrl"] : (function () { throw new RuntimeError('Variable "promoVideoUrl" does not exist.', 21, $this->source); })())), "html", null, true);
        yield "\" rel=\"noreferrer noopener\" target=\"_blank\">
        ...
        yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::urlencode((isset($context["shareTextLong"]) || array_key_exists("shareTextLong", $context) ? $context["shareTextLong"] : (function () { throw new RuntimeError('Variable "shareTextLong" does not exist.', 26, $this->source); })()), true), "html", null, true);
        yield "&subject=";
        yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::urlencode((isset($context["shareText"]) || array_key_exists("shareText", $context) ? $context["shareText"] : (function () { throw new RuntimeError('Variable "shareText" does not exist.', 26, $this->source); })()), true), "html", null, true);
        yield "\" target=\"_blank\">
...
", "@CoreHome/getPromoVideo.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/CoreHome/templates/getPromoVideo.twig");
    }
}
