...
class __TwigTemplate_1ff3b39831acaa7008217362766cc5dd extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 4
        if ((Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["reports"]) || array_key_exists("reports", $context) ? $context["reports"] : (function () { throw new RuntimeError('Variable "reports" does not exist.', 4, $this->source); })()), "getColumns", [], "any", false, false, false, 4)) > 0)) {
            // line 5
        ...
        <table class=\"dataTable\"
            ...
            $context['_seq'] = CoreExtension::ensureTraversable(Matomo\Dependencies\Twig\Extension\CoreExtension::filter($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["reports"]) || array_key_exists("reports", $context) ? $context["reports"] : (function () { throw new RuntimeError('Variable "reports" does not exist.', 8, $this->source); })()), "getDataTables", [], "method", false, false, false, 8), function ($__dataTable__) use ($context, $macros) { $context["dataTable"] = $__dataTable__; return (CoreExtension::getAttribute($this->env, $this->source, $context["dataTable"], "getRowsCount", [], "any", false, false, false, 8) > 0); }));
            $context['loop'] = [
    ...
    {% endif %}
</div>", "@Insights/overviewWidget.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Insights/templates/overviewWidget.twig");
    }
}
