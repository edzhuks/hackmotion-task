...
class __TwigTemplate_9d643a39cf6526e3f00d6b368ef9fab8 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 4
        if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 4, $this->source); })()), "getColumn", ["visitIp"], "method", false, false, false, 4))) {
            // line 5
            yield "<span class=\"visitor-log-ip-location visitorLogTooltip\" title=\"";
            if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 5, $this->source); })()), "getColumn", ["userId"], "method", false, false, false, 5))) {
...
";
            ...
            // line 6
            if (((isset($context["isProfileEnabled"]) || array_key_exists("isProfileEnabled", $context) ? $context["isProfileEnabled"] : (function () { throw new RuntimeError('Variable "isProfileEnabled" does not exist.', 6, $this->source); })()) &&  !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 6, $this->source); })()), "getColumn", ["visitorId"], "method", false, false, false, 6)))) {
...
";
            ...
            // line 7
            if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 7, $this->source); })()), "getColumn", ["idVisit"], "method", false, false, false, 7))) {
                // line 8
...
";
    ...
    ";
                // line 16
                if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 16, $this->source); })()), "getColumn", ["city"], "method", false, false, false, 16))) {
    ...
    ";
            // line 18
            if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 18, $this->source); })()), "getColumn", ["userId"], "method", false, false, false, 18))) {
                yield "<br/><br/>";
...
{% endif %}
", "@Live/_visitorDetails.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Live/templates/_visitorDetails.twig");
    }
}
