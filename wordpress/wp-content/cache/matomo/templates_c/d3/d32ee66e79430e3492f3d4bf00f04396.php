...
class __TwigTemplate_f81985c230706b9237e38d21918398ea extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 9, $this->source); })()), "getColumn", ["referrerType"], "method", false, false, false, 9) == "campaign")) {
            ...
            ";
            // line 11
            if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 11, $this->source); })()), "getColumn", ["referrerKeyword"], "method", false, false, false, 11))) {
                yield " - ";
    ...
    ";
        ...
        ";
            ...
            // line 35
            yield "        ";
            $context["keyword"] = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            // line 36
            yield "        ";
            $context["searchName"] = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            // line 37
            yield "        ";
            $context["position"] = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
                yield "#";
...
", "@Referrers/_visitorDetails.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Referrers/templates/_visitorDetails.twig");
    }
}
