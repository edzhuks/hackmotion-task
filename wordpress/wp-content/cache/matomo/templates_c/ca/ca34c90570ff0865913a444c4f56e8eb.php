...
class __TwigTemplate_aed4e43c08d61833dada0a874a203d37 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        <div class=\"visitor-profile-info\">
            <div class=\"visitor-profile-overview\">
                <div class=\"visitor-profile-header\">
                    <div class=\"visitor-profile-avatar\">
                        <img src=\"";
            // line 21
            yield \Piwik\piwik_escape_filter($this->env, ((CoreExtension::getAttribute($this->env, $this->source, ($context["visitorData"] ?? null), "visitorAvatar", [], "any", true, true, false, 21)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["visitorData"] ?? null), "visitorAvatar", [], "any", false, false, false, 21), "plugins/Live/images/unknown_avatar.png")) : ("plugins/Live/images/unknown_avatar.png")), "html", null, true);
            yield "\"
                             alt=\"";
            // line 22
            yield \Piwik\piwik_escape_filter($this->env, ((CoreExtension::getAttribute($this->env, $this->source, ($context["visitorData"] ?? null), "visitorDescription", [], "any", true, true, false, 22)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["visitorData"] ?? null), "visitorDescription", [], "any", false, false, false, 22), "")) : ("")), "html", null, true);
            yield "\"
                             title=\"";
            // line 23
            yield \Piwik\piwik_escape_filter($this->env, ((CoreExtension::getAttribute($this->env, $this->source, ($context["visitorData"] ?? null), "visitorDescription", [], "any", true, true, false, 23)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["visitorData"] ?? null), "visitorDescription", [], "any", false, false, false, 23), "")) : ("")), "html", null, true);
            yield "\"/>
                    </div>
                    <div class=\"visitor-profile-header-details\">
                        <div class=\"visitor-profile-headline\">
                            ";
            // line 27
            if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitorData"]) || array_key_exists("visitorData", $context) ? $context["visitorData"] : (function () { throw new RuntimeError('Variable "visitorData" does not exist.', 27, $this->source); })()), "previousVisitorId", [], "any", false, false, false, 27))) {
            ...
            yield "                            <h1>";
            // line 32
            if (Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitorData"]) || array_key_exists("visitorData", $context) ? $context["visitorData"] : (function () { throw new RuntimeError('Variable "visitorData" does not exist.', 32, $this->source); })()), "userId", [], "any", false, false, false, 32))) {
                // line 33
                yield "                                    ";
            ...
            yield "</h1>
                            ";
            // line 38
            if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitorData"]) || array_key_exists("visitorData", $context) ? $context["visitorData"] : (function () { throw new RuntimeError('Variable "visitorData" does not exist.', 38, $this->source); })()), "nextVisitorId", [], "any", false, false, false, 38))) {
            ...
            yield "                        </div>
                        <div class=\"visitor-profile-latest-visit\">
                            <div class=\"visitor-profile-id\">
                                <span>";
            // line 45
            yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::upper($this->env->getCharset(), $this->env->getFilter('translate')->getCallable()("General_Id")), "html", null, true);
            yield "</span>
                                ";
            // line 46
            ...
            yield "\">
                            ...
                            ";
            // line 56
            yield $this->env->getFunction('postEvent')->getCallable()("Live.renderVisitorIcons", Matomo\Dependencies\Twig\Extension\CoreExtension::first($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitorData"]) || array_key_exists("visitorData", $context) ? $context["visitorData"] : (function () { throw new RuntimeError('Variable "visitorData" does not exist.', 56, $this->source); })()), "lastVisits", [], "any", false, false, false, 56)));
            yield "
                        </div>
                    </div>
                </div>
            ...
            yield "                    </ol>
                ...
                <div class=\"visitor-profile-more-info\">
                    ";
            // line 72
            if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["visitorData"]) || array_key_exists("visitorData", $context) ? $context["visitorData"] : (function () { throw new RuntimeError('Variable "visitorData" does not exist.', 72, $this->source); })()), "lastVisits", [], "any", false, false, false, 72), "getRowsCount", [], "method", false, false, false, 72) >= Matomo\Dependencies\Twig\Extension\CoreExtension::constant("Piwik\\Plugins\\Live\\VisitorProfile::VISITOR_PROFILE_MAX_VISITS_TO_SHOW"))) {
                // line 73
                yield "                        <a href=\"#\">";
...
{% endif %}", "@Live/getVisitorProfilePopup.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Live/templates/getVisitorProfilePopup.twig");
    }
}
