...
class __TwigTemplate_4131b267c8f6be61ceac61009e9116fd extends Template
{
    private $source;
    private $macros = [];
...
<ul class=\"right hide-on-med-and-down\" role=\"menu\">
    ...
    ";
        // line 52
        $___internal_parse_0_ = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            // line 53
            yield "        ";
        ...
        // line 52
        yield Matomo\Dependencies\Twig\Extension\CoreExtension::spaceless($___internal_parse_0_);
        // line 57
        yield "</ul>
    ...
    public function macro_menuItemLabel($__label__ = null, $__icon__ = null, ...$__varargs__)
    {
        ...
        return ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            if (((array_key_exists("icon", $context) && (isset($context["icon"]) || array_key_exists("icon", $context) ? $context["icon"] : (function () { throw new RuntimeError('Variable "icon" does not exist.', 4, $this->source); })())) && (is_string($__internal_compile_0 = (isset($context["icon"]) || array_key_exists("icon", $context) ? $context["icon"] : (function () { throw new RuntimeError('Variable "icon" does not exist.', 4, $this->source); })())) && is_string($__internal_compile_1 = "icon-") && str_starts_with($__internal_compile_0, $__internal_compile_1)))) {
                ...
                yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::striptags((isset($context["icon"]) || array_key_exists("icon", $context) ? $context["icon"] : (function () { throw new RuntimeError('Variable "icon" does not exist.', 5, $this->source); })())), "html", null, true);
                yield "\" aria-label=\"";
        ...
        ";
            ...
            ";
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["menu"] ?? null), "_url", [], "any", false, true, false, 21), "module", [], "any", true, true, false, 21)) {
                    // line 22
                    yield "                  id=\"topmenu-";
                    yield \Piwik\piwik_escape_filter($this->env, Matomo\Dependencies\Twig\Extension\CoreExtension::lower($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["menu"]) || array_key_exists("menu", $context) ? $context["menu"] : (function () { throw new RuntimeError('Variable "menu" does not exist.', 22, $this->source); })()), "_url", [], "any", false, false, false, 22), "module", [], "any", false, false, false, 22)), "html", null, true);
                    yield "\"
                  href=\"index.php";
                    // line 23
...
<a href=\"javascript:;\" data-target=\"mobile-left-menu\" class=\"activateLeftMenu hide-on-large-only button-collapse sidenav-trigger\" style=\"display:none;\"><span class=\"icon-menu-hamburger\"></span></a>
<a href=\"javascript:;\" data-target=\"mobile-top-menu\" class=\"activateTopMenu hide-on-large-only button-collapse sidenav-trigger\"><span class=\"icon-more-verti\"></span></a>
", "@CoreHome/_topBar.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/CoreHome/templates/_topBar.twig");
    }
}
