...
class __TwigTemplate_22110a266777735c6a615937939c93ee extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 6
        yield "    <div
        vue-entry=\"TagManager.TriggerManage\"
        id-container=\"";
        // line 8
        ...
        triggers-help-text=\"";
        // line 10
        yield \Piwik\piwik_escape_filter($this->env, json_encode((isset($context["triggersHelpText"]) || array_key_exists("triggersHelpText", $context) ? $context["triggersHelpText"] : (function () { throw new RuntimeError('Variable "triggersHelpText" does not exist.', 10, $this->source); })())), "html", null, true);
        yield "\"
    ></div>
";
        return; yield '';
...
{% block content %}
    ...
    ></div>
{% endblock %}", "@TagManager/manageTriggers.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/TagManager/templates/manageTriggers.twig");
    }
}
