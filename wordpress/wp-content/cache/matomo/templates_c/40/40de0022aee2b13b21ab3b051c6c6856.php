...
class __TwigTemplate_dbf946931e0a4a276403ae0f6ab1e363 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <ul>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["challenge"]) {
                ...
                // line 31
                yield "                    ";
                if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["challenge"], "url", [], "any", false, false, false, 31))) {
                    // line 32
                    yield "                        <a href=\"";
...
", "@Tour/engagement.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Tour/templates/engagement.twig");
    }
}
