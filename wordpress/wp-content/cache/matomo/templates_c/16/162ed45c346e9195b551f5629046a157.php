...
class __TwigTemplate_48ecb1546e3a6a9232a3f698291d91d2 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        $context["isPiwikDemo"] = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
...
";
        // line 3
        $context["updateCheck"] = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            // line 4
            yield "    <span id=\"updateCheckLinkContainer\">
        <span class=\"icon icon-fixed icon-reload\"></span>
        ";
            // line 6
            yield \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('translate')->getCallable()(((((array_key_exists("lastUpdateCheckFailed", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["lastUpdateCheckFailed"]) || array_key_exists("lastUpdateCheckFailed", $context) ? $context["lastUpdateCheckFailed"] : (function () { throw new RuntimeError('Variable "lastUpdateCheckFailed" does not exist.', 6, $this->source); })()), false)) : (false))) ? ("General_ErrorTryAgain") : ("CoreHome_CheckForUpdates"))), "html", null, true);
            yield "
    </span>
";
            return; yield '';
...
array_key_exists("isAdminArea", $context) && (isset($context["isAdminArea"]) || array_key_exists("isAdminArea", $context) ? $context["isAdminArea"] : (function () { throw new RuntimeError('Variable "isAdminArea" does not exist.', 17, $this->source); })()))))))) {
    ...
    last-update-check-failed=\"";
            // line 23
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("lastUpdateCheckFailed", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["lastUpdateCheckFailed"]) || array_key_exists("lastUpdateCheckFailed", $context) ? $context["lastUpdateCheckFailed"] : (function () { throw new RuntimeError('Variable "lastUpdateCheckFailed" does not exist.', 23, $this->source); })()), false)) : (false))), "html", null, true);
            yield "\"
    latest-version-available=\"";
            // line 24
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("latest_version_available", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["latest_version_available"]) || array_key_exists("latest_version_available", $context) ? $context["latest_version_available"] : (function () { throw new RuntimeError('Variable "latest_version_available" does not exist.', 24, $this->source); })()), null)) : (null))), "html", null, true);
            yield "\"
    is-multi-server-environment=\"";
            // line 25
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("isMultiServerEnvironment", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["isMultiServerEnvironment"]) || array_key_exists("isMultiServerEnvironment", $context) ? $context["isMultiServerEnvironment"] : (function () { throw new RuntimeError('Variable "isMultiServerEnvironment" does not exist.', 25, $this->source); })()), false)) : (false))), "html", null, true);
            yield "\"
    is-piwik-demo=\"";
            // line 26
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("isPiwikDemo", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["isPiwikDemo"]) || array_key_exists("isPiwikDemo", $context) ? $context["isPiwikDemo"] : (function () { throw new RuntimeError('Variable "isPiwikDemo" does not exist.', 26, $this->source); })()), false)) : (false))), "html", null, true);
            yield "\"
    is-super-user=\"";
            // line 27
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("isSuperUser", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["isSuperUser"]) || array_key_exists("isSuperUser", $context) ? $context["isSuperUser"] : (function () { throw new RuntimeError('Variable "isSuperUser" does not exist.', 27, $this->source); })()), false)) : (false))), "html", null, true);
            yield "\"
    is-admin-area=\"";
            // line 28
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("isAdminArea", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["isAdminArea"]) || array_key_exists("isAdminArea", $context) ? $context["isAdminArea"] : (function () { throw new RuntimeError('Variable "isAdminArea" does not exist.', 28, $this->source); })()), false)) : (false))), "html", null, true);
            yield "\"
    is-internet-enabled=\"";
            // line 29
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("isInternetEnabled", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["isInternetEnabled"]) || array_key_exists("isInternetEnabled", $context) ? $context["isInternetEnabled"] : (function () { throw new RuntimeError('Variable "isInternetEnabled" does not exist.', 29, $this->source); })()), false)) : (false))), "html", null, true);
            yield "\"
    update-check=\"";
            // line 30
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("updateCheck", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["updateCheck"]) || array_key_exists("updateCheck", $context) ? $context["updateCheck"] : (function () { throw new RuntimeError('Variable "updateCheck" does not exist.', 30, $this->source); })()))) : (""))), "html", null, true);
            yield "\"
    has-some-view-access=\"";
            // line 31
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("hasSomeViewAccess", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["hasSomeViewAccess"]) || array_key_exists("hasSomeViewAccess", $context) ? $context["hasSomeViewAccess"] : (function () { throw new RuntimeError('Variable "hasSomeViewAccess" does not exist.', 31, $this->source); })()), false)) : (false))), "html", null, true);
            yield "\"
    is-anonymous=\"";
            // line 32
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("isUserIsAnonymous", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["isUserIsAnonymous"]) || array_key_exists("isUserIsAnonymous", $context) ? $context["isUserIsAnonymous"] : (function () { throw new RuntimeError('Variable "isUserIsAnonymous" does not exist.', 32, $this->source); })()), false)) : (false))), "html", null, true);
            yield "\"
    contact-email=\"";
            // line 33
    ...
    piwik-version=\"";
            // line 34
            yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("piwik_version", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["piwik_version"]) || array_key_exists("piwik_version", $context) ? $context["piwik_version"] : (function () { throw new RuntimeError('Variable "piwik_version" does not exist.', 34, $this->source); })()), null)) : (null))), "html", null, true);
            yield "\"
...
<span class=\"icon icon-arrowup\"></span>
{% endif %}
", "@CoreHome/_headerMessage.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/CoreHome/templates/_headerMessage.twig");
    }
}
