...
class __TwigTemplate_42a933b0809d7fcf03264f2aacf30995 extends Template
{
    private $source;
    private $macros = [];
    ...
    data-table-actions=\"";
        // line 15
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "datatable_actions", [], "any", true, true, false, 15)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "datatable_actions", [], "any", false, false, false, 15), [])) : ([]))), "html", null, true);
        yield "\"
    show-flatten-table=\"";
        // line 16
    ...
    has-multiple-dimensions=\"";
        // line 18
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("hasMultipleDimensions", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["hasMultipleDimensions"]) || array_key_exists("hasMultipleDimensions", $context) ? $context["hasMultipleDimensions"] : (function () { throw new RuntimeError('Variable "hasMultipleDimensions" does not exist.', 18, $this->source); })()), false)) : (false))), "html", null, true);
        yield "\"
    is-data-table-empty=\"";
        // line 19
    ...
    show-totals-row=\"";
        // line 20
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_totals_row", [], "any", true, true, false, 20)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_totals_row", [], "any", false, false, false, 20), false)) : (false))), "html", null, true);
        yield "\"
    show-exclude-low-population=\"";
        // line 21
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_exclude_low_population", [], "any", true, true, false, 21)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_exclude_low_population", [], "any", false, false, false, 21), false)) : (false))), "html", null, true);
        yield "\"
    show-pivot-by-subtable=\"";
        // line 22
        yield \Piwik\piwik_escape_filter($this->env, json_encode((((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_pivot_by_subtable", [], "any", true, true, false, 22)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_pivot_by_subtable", [], "any", false, false, false, 22), false)) : (false)) &&  !((array_key_exists("isComparing", $context)) ? (Matomo\Dependencies\Twig\Extension\CoreExtension::default((isset($context["isComparing"]) || array_key_exists("isComparing", $context) ? $context["isComparing"] : (function () { throw new RuntimeError('Variable "isComparing" does not exist.', 22, $this->source); })()), false)) : (false)))), "html", null, true);
        yield "\"
    show-periods=\"";
        // line 23
...
></div>
", "@CoreHome/_dataTableActions.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/CoreHome/templates/_dataTableActions.twig");
    }
}
