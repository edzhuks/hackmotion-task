...
class __TwigTemplate_81171649dfcd0a4113ee29a6a5d4b817 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["visitor"]) {
            // line 5
            yield "    ";
            $context["visitorRow"] = ('' === $tmp = \Matomo\Dependencies\Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
                // line 6
                yield "        <div class=\"card row hoverable\">

            ";
                // line 8
                if (( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["visitor"], "getColumn", ["visitorId"], "method", false, false, false, 8)) &&  !CoreExtension::getAttribute($this->env, $this->source, (isset($context["clientSideParameters"]) || array_key_exists("clientSideParameters", $context) ? $context["clientSideParameters"] : (function () { throw new RuntimeError('Variable "clientSideParameters" does not exist.', 8, $this->source); })()), "hideProfileLink", [], "any", false, false, false, 8))) {
                    // line 9
                    ...
                    // line 11
                    if ( !Matomo\Dependencies\Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["visitor"], "getColumn", ["userId"], "method", false, false, false, 11))) {
                        yield ": ";
        ...
        ";
            ...
            <div class=\"col s12 m";
                ...
                <strong>
                    ";
                // line 30
                $context["actionCount"] = Matomo\Dependencies\Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["visitor"], "getColumn", ["actionDetails"], "method", false, false, false, 30));
                // line 31
                yield "                    ";
...
{% for visitor in dataTable.getRows() %}
    ...
    {{ visitorRow }}
{% endfor %}
", "@Live/_dataTableViz_visitorLog.twig", "/var/www/html/wp-content/plugins/matomo/app/plugins/Live/templates/_dataTableViz_visitorLog.twig");
    }
}
